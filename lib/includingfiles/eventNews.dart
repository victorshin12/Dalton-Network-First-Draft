...
class EventNews extends StatefulWidget {
  EventNews({Key? key, required this.title}) : super(key: key);

  final String title;

  @override
  _EventNews createState() => _EventNews();
}

class _EventNews extends State<EventNews> {
  ...
  var url2 = Uri.parse('https://cdsnet.kr/flutterConn/eventNewsWeek.php');
  var url3 = Uri.parse('https://cdsnet.kr/flutterConn/eventNewsMonth.php');
  var url4 = Uri.parse('https://cdsnet.kr/flutterConn/eventNewsAll.php');
